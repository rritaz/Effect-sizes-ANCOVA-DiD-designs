    ...
    for (i in 1:10000){
        ...
        df_gains <- trtANDctrl_df %>% 
            mutate(
                ...
                v_1 = ((1/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+(unbiased_t1^2/(2*(n_trt+n_ctrl-2)))),
                ...
                v_2 =  (((2*(1-rho))/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((unbiased_t2^2)/(2*(n_trt+n_ctrl-2)))),
                ...
                v_5 = ((2*(1-corr_pooled))/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((unbiased_t5^2)/(2*(n_trt+n_ctrl-2))),
                ...
                v_5_trueRho = (((2*(1-rho))/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((unbiased_t5_trueRho^2)/(2*(n_trt+n_ctrl-2)))),
                ...
                v_10 = (1/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((1+rho^2)*(unbiased_t10^2)/(4*(n_trt+n_ctrl-2))),
                ...
                v_11 = ((2*(1-rho))/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((1+rho^2)*(unbiased_t11^2)/(4*(n_trt+n_ctrl-2))),
        ...
        df_adjusted <- df_complete_ancova %>% 
            ...
            mutate(
                ...
                v_3 = ((1-rho^2)/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((unbiased_t3^2)/(2*(n_trt+n_ctrl-2))),
                ...
                v_9 = ((1-corr_pooled^2)/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((unbiased_t9^2)/(2*(n_trt+n_ctrl-2-q))),
                ...
                v_9_trueRho = ((1-rho^2)/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((unbiased_t9_trueRho^2)/(2*(n_trt+n_ctrl-2-q))),
                ...
                v_12 = (((1-rho^2))/((n_trt*n_ctrl)/(n_trt+n_ctrl)))+((1+rho^2)*(unbiased_t12^2)/(4*(n_trt+n_ctrl-2))),
